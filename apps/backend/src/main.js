...
function start() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const app = yield NestFactory.create(AppModule, {
            rawBody: true,
            cors: Object.assign(Object.assign({}, (!process.env.NOT_SECURED ? { credentials: true } : {})), { allowedHeaders: ['Content-Type', 'Authorization', 'auth', 'showorg'], exposedHeaders: ['reload', 'onboarding', 'activate'], origin: [
